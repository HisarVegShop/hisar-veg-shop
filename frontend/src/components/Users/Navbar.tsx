      ...
      <div className="w-full flex justify-end items-center">
        ...
        <ul className="flex space-x-4 items-center  flex-col-reverse w-full sm:flex-row sm:justify-end gap-2">
          ...
          <div className="flex items-center space-x-2 self-end">
            <li
              className="bg-white px-5 py-1.5 rounded-full flex items-center gap-1 cursor-pointer hover:bg-gray-50"
            ...
            <li
              className="bg-white px-2 py-1.5 rounded-full flex items-center cursor-pointer hover:bg-gray-50"
