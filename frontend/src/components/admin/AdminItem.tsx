...
const AdminItem = ({
  ...
  const { name, img, price: AllPrice } = product;
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-full flex flex-row">  
        <button className="bg-primary h-7 rounded-l-[34px] left-0  w-full  text-gray-50 cursor-pointer">
          View
        </button>
        <button
          className="bg-gray-700 h-7 rounded-r-[34px] left-0  w-full text-gray-50 cursor-pointer"
