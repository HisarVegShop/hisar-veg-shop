...
import type { Product } from "./AdminItemList";
import { useDispatch, useSelector } from "react-redux";
import {
  addQuantityToCart,
  removeQuantityFromCart,
} from "../../store/slices/cartSlice";
const AdminOptionContainer = ({
  selectedProduct,
  handleProductClick,
  setEditingProduct,
}: {
  ...
  return (
    ...
    >
      <div
        className="w-fit text-end fixed bottom-50  bg-black text-white right-0  curser-pointer"
          ...
          return (
            <div className="md:w-90 w-[100%] flex flex-row relative justify-between items-center h-fit bg-gray-100 shadow-md shadow-gray-200 rounded-[8px]  pr-4 pl-1">
              ...
              <div className="w-30  flex justify-center items-center  ">
                <div className="px-2 bg-gray-600 text-white rounded-2xl hover:bg-gray-800 cursor-pointer" onClick={() => setEditingProduct(selectedProduct)}>
                  View
                </div>
